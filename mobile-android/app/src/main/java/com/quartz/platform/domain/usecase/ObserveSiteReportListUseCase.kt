                ...
                when (matched) {
                    ...
                    is ThroughputReportClosureProjection -> {
                        ReportListClosureSummary.Throughput(
                            ...
                            observedNetworkStatus = matched.observedNetworkStatus,
                            observedBatteryLevelPercent = matched.observedBatteryLevelPercent,
                            observedLocationAvailable = matched.observedLocationAvailable,
                            requiredStepCount = matched.requiredStepCount,
                            completedRequiredStepCount = matched.completedRequiredStepCount,
                    ...
                    is QosReportClosureProjection -> {
                        ...
                        ReportListClosureSummary.Qos(
                            ...
                            recoveryState = matched.recoveryState,
                            preconditionsReady = matched.preconditionsReady,
                            observedNetworkStatus = matched.observedNetworkStatus,
                            observedBatteryLevelPercent = matched.observedBatteryLevelPercent,
                            observedLocationAvailable = matched.observedLocationAvailable,
                            observedSignalsCapturedAtEpochMillis = matched.observedSignalsCapturedAtEpochMillis,
                            requiredStepCount = matched.requiredStepCount,
                            completedRequiredStepCount = matched.completedRequiredStepCount,
                            ...
                            blockedFamilyCount = matched.blockedFamilyCount,
                            dominantIssueCode = matched.dominantIssueCode,
                            timelineEventCount = matched.executionTimelineEvents.size,
                            timelineFamilyCoverageCount = matched.timelineFamilyCoverageCount,
                            requiredRepeatCount = matched.requiredRepeatCount,
                            ...
                            checkpointCount = matched.checkpointCount,
                            ...
                            nextFamily = matched.nextFamily,
                            nextRepetitionIndex = matched.nextRepetitionIndex,
        ...
        return when (latestPerformanceProjection) {
            is ThroughputReportClosureProjection -> {
                ReportListClosureSummary.Throughput(
                    ...
                    observedNetworkStatus = latestPerformanceProjection.observedNetworkStatus,
                    observedBatteryLevelPercent = latestPerformanceProjection.observedBatteryLevelPercent,
                    observedLocationAvailable = latestPerformanceProjection.observedLocationAvailable,
            ...
            is QosReportClosureProjection -> {
                ...
                ReportListClosureSummary.Qos(
                    ...
                    recoveryState = latestPerformanceProjection.recoveryState,
                    preconditionsReady = latestPerformanceProjection.preconditionsReady,
                    observedNetworkStatus = latestPerformanceProjection.observedNetworkStatus,
                    observedBatteryLevelPercent = latestPerformanceProjection.observedBatteryLevelPercent,
                    observedLocationAvailable = latestPerformanceProjection.observedLocationAvailable,
                    observedSignalsCapturedAtEpochMillis = latestPerformanceProjection.observedSignalsCapturedAtEpochMillis,
                    requiredStepCount = latestPerformanceProjection.requiredStepCount,
                    completedRequiredStepCount = latestPerformanceProjection.completedRequiredStepCount,
                    ...
                    blockedFamilyCount = latestPerformanceProjection.blockedFamilyCount,
                    dominantIssueCode = latestPerformanceProjection.dominantIssueCode,
                    timelineEventCount = latestPerformanceProjection.executionTimelineEvents.size,
                    timelineFamilyCoverageCount = latestPerformanceProjection.timelineFamilyCoverageCount,
                    requiredRepeatCount = latestPerformanceProjection.requiredRepeatCount,
                    ...
                    checkpointCount = latestPerformanceProjection.checkpointCount,
                    ...
                    nextFamily = latestPerformanceProjection.nextFamily,
                    nextRepetitionIndex = latestPerformanceProjection.nextRepetitionIndex,
