...
@Composable
internal fun XfeederMissionHeader(
...
@Composable
internal fun XfeederRuntimeStateBanner(state: XfeederGuidedSessionUiState) {
...
@Composable
internal fun XfeederMissionProgressCard(state: XfeederGuidedSessionUiState) {
...
@Composable
internal fun OutcomeCaptureCard(
    state: XfeederGuidedSessionUiState,
...
@Composable
internal fun GeospatialSessionSurfaceCard(
    state: XfeederGuidedSessionUiState,
...
private fun XfeederSessionMapView(
    ...
    var overlaysVersion by remember { mutableIntStateOf(-1) }
...
internal data class XfeederProgressSnapshot(
...
internal fun XfeederGuidedSession.toProgressSnapshot(): XfeederProgressSnapshot {
